...
export class AddFacultyComponent {
  ...
  onSubmit() {
    ...
    if (this.addFacultyForm.valid) {
      ...
      formData.append(
        'contact_no',
        this.addFacultyForm.get('contact_no')?.value
      );
      ...
      formData.append(
        'graduation_institue',
        this.addFacultyForm.get('graduation_institue')?.value
      );
      formData.append(
        'grdt_stream',
        this.addFacultyForm.get('grdt_stream')?.value
      );
      formData.append(
        'grdt_passing_year',
        this.addFacultyForm.get('grdt_passing_year')?.value
      );
      formData.append(
        'grdt_percentage',
        this.addFacultyForm.get('grdt_percentage')?.value
      );
      formData.append(
        'last_education',
        this.addFacultyForm.get('last_education')?.value
      );
      formData.append(
        'last_ed_stream',
        this.addFacultyForm.get('last_ed_stream')?.value
      );
      formData.append(
        'last_ed_passing_year',
        this.addFacultyForm.get('last_ed_passing_year')?.value
      );
      formData.append(
        'last_ed_percentage',
        this.addFacultyForm.get('last_ed_percentage')?.value
      );
      formData.append(
        'previous_school',
        this.addFacultyForm.get('previous_school')?.value
      );
      formData.append(
        'prev_designation',
        this.addFacultyForm.get('prev_designation')?.value
      );
      formData.append(
        'prev_experience',
        this.addFacultyForm.get('prev_experience')?.value
      );
      formData.append(
        'prev_speciality',
        this.addFacultyForm.get('prev_speciality')?.value
      );
      formData.append(
        'last_salary',
        this.addFacultyForm.get('last_salary')?.value
      );
      formData.append(
        'current_salary',
        this.addFacultyForm.get('current_salary')?.value
      );
      formData.append('bank_name', this.addFacultyForm.get('bank_name')?.value);
      formData.append(
        'account_no',
        this.addFacultyForm.get('account_no')?.value
      );
      ...
      formData.append(
        'admin_id_fk',
        this.addFacultyForm.get('admin_id_fk')?.value
      );
